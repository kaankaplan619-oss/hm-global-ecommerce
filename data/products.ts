...
import {
  ...
  SACOCHE_BAGBASE_QS309_BRODERIE_VOLUME,
...
export const PRODUCT_SACOCHE_BAGBASE_QS309: Product = {
  ...
  gender: "unisex",
  tier: "standard",
  description: "Sacoche bandoulière compacte et moderne pour le staff événementiel et les équipes terrain : votre logo brodé, toujours visible en mobilité. Production et expédition UE.",
  ...
  pricing: {
    dtf: 0, dtflex: 0, flex: 0,
    broderie: SACOCHE_BAGBASE_QS309_PRICES.broderie,
    placements: SINGLE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: SINGLE_PLACEMENT_SURCHARGES,
  },
  featured: false,
  ...
  conseil: "Le logo brodé en mobilité : idéal staff et accueil. 46,90 € l'unité dès 10 pièces.",
  volumePricing: SACOCHE_BAGBASE_QS309_BRODERIE_VOLUME,
  hmMockupImages: {
