...
import {
  ...
  // Élargissement catalogue #85 (2026-06-12)
  POLO_SOLS_PRESCOTT_PRICES,
  POLO_SOLS_PRESCOTT_BRODERIE_VOLUME,
  POLO_GILDAN_64800L_PRICES,
  POLO_GILDAN_64800L_BRODERIE_VOLUME,
  COUPE_VENT_SOLS_32000_PRICES,
  COUPE_VENT_SOLS_32000_BRODERIE_VOLUME,
  CASQUETTE_DAD_HAT_6245_PRICES,
  CASQUETTE_DAD_HAT_6245_BRODERIE_VOLUME,
  CASQUETTE_SNAPBACK_6089_PRICES,
  CASQUETTE_SNAPBACK_6089_BRODERIE_VOLUME,
  BOB_FLEXFIT_5003_PRICES,
  BOB_FLEXFIT_5003_BRODERIE_VOLUME,
  BONNET_YUPOONG_1501KC_PRICES,
  BONNET_YUPOONG_1501KC_BRODERIE_VOLUME,
  TOTE_BAGBASE_W101_PRICES,
  TOTE_BAGBASE_W101_DTF_VOLUME,
  TOTE_BAGBASE_W101_BRODERIE_VOLUME,
  TOTE_DENIM_MANTIS_M196_PRICES,
  TOTE_DENIM_MANTIS_M196_BRODERIE_VOLUME,
  SACOCHE_BAGBASE_QS309_PRICES,
  SACOCHE_BAGBASE_QS309_DTF_VOLUME,
  STICKERS_LOGO_PRICES,
  STICKERS_LOGO_DTF_VOLUME,
  PLANCHE_STICKERS_PRICES,
  PLANCHE_STICKERS_DTF_VOLUME,
  MUG_NOIR_PRICES,
  MUG_NOIR_DTF_VOLUME,
  DESSOUS_VERRE_PRICES,
  DESSOUS_VERRE_DTF_VOLUME,
  SINGLE_PLACEMENT_SURCHARGES,
} from "./pricing";
...
// ═══════════════════════════════════════════════════════════════════════════
// ÉLARGISSEMENT CATALOGUE #85 (2026-06-12) — Printful POD, stock EU vérifié
// variant par variant (cf lib/printfulVariantMap.ts). Flow simple (upload
// fiche produit) : broderie/impression à emplacement fixe, pas de studio.
// ═══════════════════════════════════════════════════════════════════════════

export const PRODUCT_POLO_SOLS_PRESCOTT: Product = {
  id: "polo-sols-prescott",
  slug: "polo-sols-prescott",
  reference: "SOL'S 11362 Prescott",
  name: "Polo piqué premium SOL'S Prescott",
  shortName: "Polo premium SOL'S",
  category: "polos",
  gender: "unisex",
  tier: "premium",
  description: "Le polo piqué premium de la marque française SOL'S : maille dense, col côtelé tenue parfaite, coupe moderne. La plus large gamme de tailles du catalogue (S au 5XL) — idéal pour équiper toute une équipe sans exception. Broderie front sur-mesure de votre logo. Production et expédition UE. Délai 7-12 jours ouvrés après BAT.",
  composition: "100% coton piqué ringspun premium",
  weight: "Maille piquée premium",
  images: [],
  colors: [
    { id: "noir",       label: "Noir",        hex: "#121212", available: true },
    { id: "marine",     label: "Marine",      hex: "#1a252e", available: true },
    { id: "rouge",      label: "Rouge",       hex: "#df0830", available: true },
    { id: "gris-chine", label: "Gris chiné",  hex: "#808080", available: true },
  ],
  sizes: [
    { label: "S",   available: true },
    { label: "M",   available: true },
  ...
  placements: ["coeur"],
  pricing: {
    dtf: 0, dtflex: 0, flex: 0,
    broderie: POLO_SOLS_PRESCOTT_PRICES.broderie,
    placements: SINGLE_PLACEMENT_SURCHARGES,
  ...
  badge: "Broderie incluse",
  supplierName: "printful",
  ideaPour: ["Corporate", "Uniformes", "Hôtellerie & restauration"],
...
export const PRODUCT_POLO_GILDAN_64800L: Product = {
  id: "polo-gildan-64800l",
  slug: "polo-gildan-64800l-femme",
  reference: "Gildan 64800L",
  name: "Polo piqué femme Gildan 64800L",
  shortName: "Polo femme",
  category: "polos",
  gender: "femme",
  tier: "standard",
  description: "La déclinaison femme du polo piqué Gildan : coupe ajustée, mêmes coloris professionnels que le modèle unisexe — parfait pour des uniformes d'équipe cohérents hommes/femmes. Broderie front sur-mesure de votre logo. Production et expédition UE. Délai 7-12 jours ouvrés après BAT.",
  composition: "100% coton piqué softstyle",
  weight: "Maille piquée",
  images: [],
  colors: [
    { id: "noir",   label: "Noir",       hex: "#111111", available: true },
    { id: "marine", label: "Marine",     hex: "#131b2d", available: true },
    { id: "gris",   label: "Gris sport", hex: "#c9cbce", available: true },
    { id: "blanc",  label: "Blanc",      hex: "#FFFFFF", available: true },
  ],
  sizes: [
    { label: "S",   available: true },
  ...
  pricing: {
    dtf: 0, dtflex: 0, flex: 0,
    broderie: POLO_GILDAN_64800L_PRICES.broderie,
    placements: SINGLE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: SINGLE_PLACEMENT_SURCHARGES,
  },
  featured: false,
...
export const PRODUCT_COUPE_VENT_SOLS_32000: Product = {
  id: "coupe-vent-sols-32000",
  slug: "coupe-vent-sols-32000",
  reference: "SOL'S 32000",
  name: "Coupe-vent brodé SOL'S 32000",
  shortName: "Coupe-vent brodé",
  category: "softshells",
  gender: "unisex",
  tier: "standard",
  description: "Coupe-vent léger et déperlant, compressible dans sa poche — l'alternative budget à la veste softshell pour les équipes terrain, l'événementiel et les clubs. Broderie cœur de votre logo. Production et expédition UE. Délai 7-12 jours ouvrés après BAT.",
  composition: "100% nylon déperlant, doublure filet",
  weight: "Coupe-vent léger",
  images: [],
  colors: [
    { id: "noir",       label: "Noir",          hex: "#1c1b1b", available: true },
    { id: "marine",     label: "Marine",        hex: "#2b2e39", available: true },
    { id: "vert-foret", label: "Vert forêt",    hex: "#283d2c", available: true },
  ],
  sizes: [
    { label: "S",   available: true },
    { label: "M",   available: true },
  ...
  pricing: {
    dtf: 0, dtflex: 0, flex: 0,
    broderie: COUPE_VENT_SOLS_32000_PRICES.broderie,
    placements: SINGLE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: SINGLE_PLACEMENT_SURCHARGES,
  },
  featured: false,
  ...
  badge: "Broderie incluse",
  supplierName: "printful",
  ideaPour: ["Équipes terrain", "Événementiel", "Clubs sportifs"],
...
export const PRODUCT_CASQUETTE_DAD_HAT_6245: Product = {
  id: "casquette-dad-hat-6245",
  slug: "casquette-dad-hat-yupoong-6245",
  reference: "Yupoong 6245CM",
  name: "Casquette Dad Hat Yupoong 6245CM brodée",
  shortName: "Dad hat brodée",
  category: "casquettes",
  gender: "unisex",
  tier: "standard",
  description: "La casquette décontractée par excellence : profil bas non structuré, 100% coton chino, boucle de réglage métal. 10 coloris dont des pastels — parfaite pour les marques lifestyle, assos et événements. Broderie front sur-mesure de votre logo. Production et expédition UE.",
  composition: "100% coton chino",
  weight: "—",
  images: [],
  colors: [
    { id: "noir",       label: "Noir",       hex: "#181717", available: true },
    { id: "blanc",      label: "Blanc",      hex: "#ffffff", available: true },
    { id: "marine",     label: "Marine",     hex: "#182031", available: true },
    { id: "gris",       label: "Gris foncé", hex: "#39353a", available: true },
    { id: "kaki",       label: "Kaki",       hex: "#b49771", available: true },
    { id: "pierre",     label: "Pierre",     hex: "#d6bdad", available: true },
    { id: "bleu-clair", label: "Bleu clair", hex: "#b5cbda", available: true },
    { id: "rose",       label: "Rose",       hex: "#fab2ba", available: true },
    { id: "bordeaux",   label: "Bordeaux",   hex: "#a3001b", available: true },
    { id: "camouflage", label: "Camouflage", hex: "#415446", available: true },
  ],
  sizes: [{ label: "One size", available: true }],
  techniques: ["broderie"],
  techniqueRecommandee: "broderie",
  ...
  pricing: {
    dtf: 0, dtflex: 0, flex: 0,
    broderie: CASQUETTE_DAD_HAT_6245_PRICES.broderie,
    placements: CASQUETTE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: CASQUETTE_PLACEMENT_SURCHARGES,
  },
  featured: false,
  ...
  badge: "Broderie incluse",
  supplierName: "printful",
  ideaPour: ["Marques & collectifs", "Associations", "Événementiel"],
  conseil: "Le style décontracté qui complète nos casquettes structurées. 10 coloris dont pastels. À partir de 23,90 € l'unité dès 25 pièces.",
  volumePricing: CASQUETTE_DAD_HAT_6245_BRODERIE_VOLUME,
  hmMockupImages: {
    "noir":       "/mockups/casquettes/yupoong-6245cm/noir-front.jpg",
    "blanc":      "/mockups/casquettes/yupoong-6245cm/blanc-front.jpg",
    "marine":     "/mockups/casquettes/yupoong-6245cm/marine-front.jpg",
    "gris":       "/mockups/casquettes/yupoong-6245cm/gris-front.jpg",
    "kaki":       "/mockups/casquettes/yupoong-6245cm/kaki-front.jpg",
    "pierre":     "/mockups/casquettes/yupoong-6245cm/pierre-front.jpg",
    "bleu-clair": "/mockups/casquettes/yupoong-6245cm/bleu-clair-front.jpg",
    "rose":       "/mockups/casquettes/yupoong-6245cm/rose-front.jpg",
    "bordeaux":   "/mockups/casquettes/yupoong-6245cm/bordeaux-front.jpg",
    "camouflage": "/mockups/casquettes/yupoong-6245cm/camouflage-front.jpg",
  },
};

export const PRODUCT_CASQUETTE_SNAPBACK_6089: Product = {
  id: "casquette-snapback-6089",
  slug: "casquette-snapback-yupoong-6089",
  reference: "Yupoong 6089M",
  name: "Casquette Snapback Yupoong 6089M brodée",
  shortName: "Snapback brodée",
  category: "casquettes",
  gender: "unisex",
  tier: "standard",
  description: "Le snapback classique 6 panneaux à visière plate — la référence urbaine pour clubs sportifs, collectifs et marques. 18 coloris dont des bicolores très demandés. Broderie front sur-mesure de votre logo. Production et expédition UE.",
  composition: "80% acrylique / 20% laine",
  weight: "—",
  images: [],
  colors: [
    { id: "noir",             label: "Noir",               hex: "#2a2a2a", available: true },
    { id: "blanc",            label: "Blanc",              hex: "#ffffff", available: true },
    { id: "marine",           label: "Marine",             hex: "#303044", available: true },
    { id: "marine-fonce",     label: "Marine foncé",       hex: "#15293a", available: true },
    { id: "gris",             label: "Gris",               hex: "#666061", available: true },
    { id: "gris-chine",       label: "Gris chiné",         hex: "#A8A59E", available: true },
    { id: "argent",           label: "Argent",             hex: "#9f9da5", available: true },
    { id: "rouge",            label: "Rouge",              hex: "#dd0b2e", available: true },
    { id: "royal",            label: "Bleu royal",         hex: "#10337a", available: true },
    { id: "bordeaux",         label: "Bordeaux",           hex: "#651929", available: true },
    { id: "sapin",            label: "Vert sapin",         hex: "#183e41", available: true },
    { id: "camouflage",       label: "Camouflage",         hex: "#4d573e", available: true },
    { id: "noir-rouge",       label: "Noir / Rouge",       hex: "#2a2a2a", available: true },
    { id: "noir-argent",      label: "Noir / Argent",      hex: "#2a2a2a", available: true },
    { id: "noir-bleu-canard", label: "Noir / Bleu canard", hex: "#2a2a2a", available: true },
    { id: "noir-rose-fluo",   label: "Noir / Rose fluo",   hex: "#2a2a2a", available: true },
    { id: "gris-chine-noir",  label: "Gris chiné / Noir",  hex: "#A8A59E", available: true },
    { id: "naturel-noir",     label: "Naturel / Noir",     hex: "#f5eee1", available: true },
  ],
  sizes: [{ label: "One size", available: true }],
  techniques: ["broderie"],
  techniqueRecommandee: "broderie",
  ...
  pricing: {
    dtf: 0, dtflex: 0, flex: 0,
    broderie: CASQUETTE_SNAPBACK_6089_PRICES.broderie,
    placements: CASQUETTE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: CASQUETTE_PLACEMENT_SURCHARGES,
  },
  featured: false,
  ...
  badge: "Broderie incluse",
  supplierName: "printful",
  ideaPour: ["Clubs sportifs", "Collectifs & crews", "Streetwear"],
  conseil: "Le meilleur choix de coloris du catalogue casquettes (18, dont bicolores). À partir de 22,90 € l'unité dès 25 pièces.",
  volumePricing: CASQUETTE_SNAPBACK_6089_BRODERIE_VOLUME,
  hmMockupImages: {
    "noir":             "/mockups/casquettes/yupoong-6089m/noir-front.jpg",
    "blanc":            "/mockups/casquettes/yupoong-6089m/blanc-front.jpg",
    "marine":           "/mockups/casquettes/yupoong-6089m/marine-front.jpg",
    "marine-fonce":     "/mockups/casquettes/yupoong-6089m/marine-fonce-front.jpg",
    "gris":             "/mockups/casquettes/yupoong-6089m/gris-front.jpg",
    "gris-chine":       "/mockups/casquettes/yupoong-6089m/gris-chine-front.jpg",
    "argent":           "/mockups/casquettes/yupoong-6089m/argent-front.jpg",
    "rouge":            "/mockups/casquettes/yupoong-6089m/rouge-front.jpg",
    "royal":            "/mockups/casquettes/yupoong-6089m/royal-front.jpg",
    "bordeaux":         "/mockups/casquettes/yupoong-6089m/bordeaux-front.jpg",
    "sapin":            "/mockups/casquettes/yupoong-6089m/sapin-front.jpg",
    "camouflage":       "/mockups/casquettes/yupoong-6089m/camouflage-front.jpg",
    "noir-rouge":       "/mockups/casquettes/yupoong-6089m/noir-rouge-front.jpg",
    "noir-argent":      "/mockups/casquettes/yupoong-6089m/noir-argent-front.jpg",
    "noir-bleu-canard": "/mockups/casquettes/yupoong-6089m/noir-bleu-canard-front.jpg",
    "noir-rose-fluo":   "/mockups/casquettes/yupoong-6089m/noir-rose-fluo-front.jpg",
    "gris-chine-noir":  "/mockups/casquettes/yupoong-6089m/gris-chine-noir-front.jpg",
    "naturel-noir":     "/mockups/casquettes/yupoong-6089m/naturel-noir-front.jpg",
  },
};

export const PRODUCT_BOB_FLEXFIT_5003: Product = {
  id: "bob-flexfit-5003",
  slug: "bob-flexfit-5003",
  reference: "Flexfit 5003",
  name: "Bob Flexfit 5003 brodé",
  shortName: "Bob brodé",
  category: "casquettes",
  gender: "unisex",
  tier: "premium",
  description: "Le bob tendance par Flexfit — coton sergé premium, forme structurée. L'accessoire festival et streetwear que les marques s'arrachent, introuvable ailleurs en broderie à l'unité. Broderie front sur-mesure de votre logo. Production et expédition UE.",
  composition: "100% coton sergé",
  weight: "—",
  images: [],
  colors: [
    { id: "noir",   label: "Noir",   hex: "#1a1a1a", available: true },
    { id: "blanc",  label: "Blanc",  hex: "#FFFFFF", available: true },
    { id: "marine", label: "Marine", hex: "#2C3848", available: true },
    { id: "gris",   label: "Gris",   hex: "#8D8790", available: true },
    { id: "kaki",   label: "Kaki",   hex: "#C3B091", available: true },
  ],
  sizes: [{ label: "One size", available: true }],
  techniques: ["broderie"],
  techniqueRecommandee: "broderie",
  ...
  pricing: {
    dtf: 0, dtflex: 0, flex: 0,
    broderie: BOB_FLEXFIT_5003_PRICES.broderie,
    placements: CASQUETTE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: CASQUETTE_PLACEMENT_SURCHARGES,
  },
  featured: false,
  visible: true,
  badge: "Pièce tendance",
  supplierName: "printful",
  ideaPour: ["Festivals & événements", "Marques lifestyle", "Cadeaux d'équipe"],
  conseil: "Le seul bob brodé disponible à l'unité en production UE — pièce différenciante. À partir de 29,90 € l'unité dès 25 pièces.",
  volumePricing: BOB_FLEXFIT_5003_BRODERIE_VOLUME,
  hmMockupImages: {
    "noir":   "/mockups/casquettes/flexfit-5003/noir-front.jpg",
    "blanc":  "/mockups/casquettes/flexfit-5003/blanc-front.jpg",
    "marine": "/mockups/casquettes/flexfit-5003/marine-front.jpg",
    "gris":   "/mockups/casquettes/flexfit-5003/gris-front.jpg",
    "kaki":   "/mockups/casquettes/flexfit-5003/kaki-front.jpg",
  },
};

export const PRODUCT_BONNET_YUPOONG_1501KC: Product = {
  id: "bonnet-yupoong-1501kc",
  slug: "bonnet-yupoong-1501kc",
  reference: "Yupoong 1501KC",
  name: "Bonnet à revers Yupoong 1501KC brodé",
  shortName: "Bonnet brodé",
  category: "casquettes",
  gender: "unisex",
  tier: "standard",
  description: "Le bonnet à revers classique en maille acrylique douce — 12 coloris. L'indispensable automne-hiver pour les équipes terrain, le BTP et les cadeaux de fin d'année. Broderie sur le revers de votre logo. Production et expédition UE.",
  composition: "100% acrylique hypoallergénique",
  weight: "—",
  images: [],
  colors: [
    { id: "noir",       label: "Noir",        hex: "#0c0c0c", available: true },
    { id: "blanc",      label: "Blanc",       hex: "#FFFFFF", available: true },
    { id: "marine",     label: "Marine",      hex: "#141323", available: true },
    { id: "gris",       label: "Gris foncé",  hex: "#2d2a2a", available: true },
    { id: "gris-chine", label: "Gris chiné",  hex: "#a19f9b", available: true },
    { id: "rouge",      label: "Rouge",       hex: "#b91616", available: true },
    { id: "royal",      label: "Bleu royal",  hex: "#222985", available: true },
    { id: "sapin",      label: "Vert sapin",  hex: "#005234", available: true },
    { id: "olive",      label: "Olive",       hex: "#41401d", available: true },
    { id: "marron",     label: "Marron",      hex: "#1f0a03", available: true },
    { id: "or",         label: "Or",          hex: "#ffa913", available: true },
    { id: "rose",       label: "Rose",        hex: "#ffc6cd", available: true },
  ],
  sizes: [{ label: "One size", available: true }],
  techniques: ["broderie"],
  techniqueRecommandee: "broderie",
  ...
  pricing: {
    dtf: 0, dtflex: 0, flex: 0,
    broderie: BONNET_YUPOONG_1501KC_PRICES.broderie,
    placements: CASQUETTE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: CASQUETTE_PLACEMENT_SURCHARGES,
  },
  featured: false,
  ...
  badge: "Broderie incluse",
  supplierName: "printful",
  ideaPour: ["BTP & équipes terrain", "Cadeaux de fin d'année", "Clubs sportifs"],
  conseil: "Le complément hiver de la gamme couvre-chefs — 12 coloris. À partir de 20,90 € l'unité dès 25 pièces.",
  volumePricing: BONNET_YUPOONG_1501KC_BRODERIE_VOLUME,
  hmMockupImages: {
    "noir":       "/mockups/casquettes/yupoong-1501kc/noir-front.jpg",
    "blanc":      "/mockups/casquettes/yupoong-1501kc/blanc-front.jpg",
    "marine":     "/mockups/casquettes/yupoong-1501kc/marine-front.jpg",
    "gris":       "/mockups/casquettes/yupoong-1501kc/gris-front.jpg",
    "gris-chine": "/mockups/casquettes/yupoong-1501kc/gris-chine-front.jpg",
    "rouge":      "/mockups/casquettes/yupoong-1501kc/rouge-front.jpg",
    "royal":      "/mockups/casquettes/yupoong-1501kc/royal-front.jpg",
    "sapin":      "/mockups/casquettes/yupoong-1501kc/sapin-front.jpg",
    "olive":      "/mockups/casquettes/yupoong-1501kc/olive-front.jpg",
    "marron":     "/mockups/casquettes/yupoong-1501kc/marron-front.jpg",
    "or":         "/mockups/casquettes/yupoong-1501kc/or-front.jpg",
    "rose":       "/mockups/casquettes/yupoong-1501kc/rose-front.jpg",
  },
};

export const PRODUCT_TOTE_BAGBASE_W101: Product = {
  id: "tote-bagbase-w101",
  slug: "tote-bag-bagbase-w101",
  reference: "BagBase W101",
  name: "Tote bag coton BagBase W101",
  shortName: "Tote bag logo",
  category: "sacs",
  gender: "unisex",
  tier: "appel",
  description: "Le tote bag coton aux longues anses, en 12 coloris — LE goodie salon et événement par excellence. Votre logo imprimé ou brodé (rare à ce prix). Production et expédition UE.",
  composition: "100% coton 140 g/m²",
  weight: "140 g/m²",
  images: [],
  colors: [
    { id: "noir",           label: "Noir",           hex: "#090909", available: true },
    { id: "naturel",        label: "Naturel",        hex: "#fffbf1", available: true },
    { id: "marine",         label: "Marine",         hex: "#0d151c", available: true },
    { id: "gris-clair",     label: "Gris clair",     hex: "#bfc1c2", available: true },
    { id: "rouge",          label: "Rouge",          hex: "#9f0019", available: true },
    { id: "bordeaux",       label: "Bordeaux",       hex: "#491729", available: true },
    { id: "vert-bouteille", label: "Vert bouteille", hex: "#05442f", available: true },
    { id: "menthe",         label: "Menthe",         hex: "#6ef9e0", available: true },
    { id: "moutarde",       label: "Moutarde",       hex: "#d39e22", available: true },
    { id: "orange",         label: "Orange",         hex: "#f95200", available: true },
    { id: "corail",         label: "Corail",         hex: "#ff5a4e", available: true },
    { id: "rose",           label: "Rose",           hex: "#ffbfd9", available: true },
  ],
  sizes: [{ label: "One size", available: true }],
  techniques: ["dtf", "broderie"],
  techniqueRecommandee: "broderie",
  placements: ["coeur"],
  pricing: {
    dtf:      TOTE_BAGBASE_W101_PRICES.dtf,
    dtflex: 0, flex: 0,
    broderie: TOTE_BAGBASE_W101_PRICES.broderie,
    placements: SINGLE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: SINGLE_PLACEMENT_SURCHARGES,
  },
  featured: false,
  ...
  badge: "Petit prix",
  supplierName: "printful",
  ideaPour: ["Salons & événements", "Goodies clients", "Commerces"],
  conseil: "Le goodie au meilleur rapport impact/prix : 12 coloris, brodable. À partir de 14,90 € imprimé dès 25 pièces.",
  volumePricing: TOTE_BAGBASE_W101_BRODERIE_VOLUME,
  volumePricingByTechnique: {
    dtf:      TOTE_BAGBASE_W101_DTF_VOLUME,
    broderie: TOTE_BAGBASE_W101_BRODERIE_VOLUME,
  },
  hmMockupImages: {
    "noir":           "/mockups/sacs/bagbase-w101/noir-front.jpg",
    "naturel":        "/mockups/sacs/bagbase-w101/naturel-front.jpg",
    "marine":         "/mockups/sacs/bagbase-w101/marine-front.jpg",
    "gris-clair":     "/mockups/sacs/bagbase-w101/gris-clair-front.jpg",
    "rouge":          "/mockups/sacs/bagbase-w101/rouge-front.jpg",
    "bordeaux":       "/mockups/sacs/bagbase-w101/bordeaux-front.jpg",
    "vert-bouteille": "/mockups/sacs/bagbase-w101/vert-bouteille-front.jpg",
    "menthe":         "/mockups/sacs/bagbase-w101/menthe-front.jpg",
    "moutarde":       "/mockups/sacs/bagbase-w101/moutarde-front.jpg",
    "orange":         "/mockups/sacs/bagbase-w101/orange-front.jpg",
    "corail":         "/mockups/sacs/bagbase-w101/corail-front.jpg",
    "rose":           "/mockups/sacs/bagbase-w101/rose-front.jpg",
  },
};

export const PRODUCT_TOTE_DENIM_MANTIS_M196: Product = {
  id: "tote-denim-mantis-m196",
  slug: "tote-bag-denim-mantis-m196",
  reference: "Mantis M196",
  name: "Tote bag denim bio Mantis M196 brodé",
  shortName: "Tote denim premium",
  category: "sacs",
  gender: "unisex",
  tier: "premium",
  description: "Le tote bag haut de gamme en denim de coton biologique — le logo brodé ressort magnifiquement sur la toile denim. Cadeau client ou de direction très différenciant. Production et expédition UE.",
  composition: "100% coton biologique, toile denim",
  weight: "Toile denim épaisse",
  images: [],
  colors: [
    { id: "denim", label: "Denim", hex: "#2f435c", available: true },
  ],
  sizes: [{ label: "One size", available: true }],
  techniques: ["broderie"],
  techniqueRecommandee: "broderie",
  ...
  pricing: {
    dtf: 0, dtflex: 0, flex: 0,
    broderie: TOTE_DENIM_MANTIS_M196_PRICES.broderie,
    placements: SINGLE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: SINGLE_PLACEMENT_SURCHARGES,
  },
  featured: false,
  ...
  badge: "Premium",
  supplierName: "printful",
  ideaPour: ["Cadeaux clients", "Direction & VIP", "RSE / coton bio"],
  conseil: "La broderie sur denim, c'est l'effet « pièce de créateur » — parfait en cadeau d'affaires. 54,90 € l'unité dès 10 pièces.",
  volumePricing: TOTE_DENIM_MANTIS_M196_BRODERIE_VOLUME,
  hmMockupImages: {
    "denim": "/mockups/sacs/mantis-m196/denim-front.jpg",
  },
};

export const PRODUCT_SACOCHE_BAGBASE_QS309: Product = {
  id: "sacoche-bagbase-qs309",
  slug: "sacoche-bandouliere-bagbase-qs309",
  reference: "BagBase QS309",
  name: "Sacoche bandoulière BagBase QS309 brodée",
  shortName: "Sacoche bandoulière",
  category: "sacs",
  gender: "unisex",
  tier: "standard",
  description: "Sacoche bandoulière compacte et moderne pour le staff événementiel et les équipes terrain : votre logo imprimé, toujours visible en mobilité. Production et expédition UE.",
  composition: "600D polyester recyclé",
  weight: "—",
  images: [],
  colors: [
    { id: "noir", label: "Noir",       hex: "#1a1a1a", available: true },
    { id: "vert", label: "Vert clair", hex: "#cfe0cb", available: true },
    { id: "rose", label: "Rose pâle",  hex: "#f5d9d0", available: true },
  ],
  sizes: [{ label: "One size", available: true }],
  techniques: ["dtf"],
  techniqueRecommandee: "dtf",
  placements: ["coeur"],
  pricing: {
    dtf: SACOCHE_BAGBASE_QS309_PRICES.dtf,
    dtflex: 0, flex: 0, broderie: 0,
    placements: SINGLE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: SINGLE_PLACEMENT_SURCHARGES,
  },
  featured: false,
  visible: true,
  badge: "Impression incluse",
  supplierName: "printful",
  ideaPour: ["Staff événementiel", "Équipes terrain", "Festivals"],
  conseil: "Le logo imprimé en mobilité : idéal staff et accueil. 46,90 € l'unité dès 10 pièces.",
  volumePricing: SACOCHE_BAGBASE_QS309_DTF_VOLUME,
  hmMockupImages: {
    "noir": "/mockups/sacs/bagbase-qs309/noir-front.jpg",
    "vert": "/mockups/sacs/bagbase-qs309/vert-front.jpg",
    "rose": "/mockups/sacs/bagbase-qs309/rose-front.jpg",
  },
};

export const PRODUCT_STICKERS_LOGO: Product = {
  id: "stickers-logo",
  slug: "stickers-logo",
  reference: "Kiss-cut premium",
  name: "Stickers logo découpe kiss-cut",
  shortName: "Stickers logo",
  category: "goodies",
  gender: "unisex",
  tier: "appel",
  description: "Votre logo en sticker vinyle premium à découpe kiss-cut (fond détachable, contour suivi). Trois formats. Pour les ordinateurs, vitrines, colis, flottes de véhicules… Production et expédition UE.",
  composition: "Vinyle blanc brillant, découpe kiss-cut",
  weight: "—",
  images: [],
  colors: [
    { id: "blanc", label: "Fond blanc", hex: "#FFFFFF", available: true },
  ],
  sizes: [
    { label: "7,6 × 7,6 cm", available: true },
    { label: "10 × 10 cm",   available: true },
    { label: "14 × 14 cm",   available: true },
  ],
  techniques: ["dtf"],
  techniqueRecommandee: "dtf",
  placements: ["coeur"],
  pricing: {
    dtf: STICKERS_LOGO_PRICES.dtf,
    dtflex: 0, flex: 0, broderie: 0,
    placements: SINGLE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: SINGLE_PLACEMENT_SURCHARGES,
  },
...
export const PRODUCT_PLANCHE_STICKERS: Product = {
  id: "planche-stickers",
  slug: "planche-stickers-a5",
  reference: "Sticker sheet A5",
  name: "Planche de stickers A5 kiss-cut",
  shortName: "Planche stickers",
  category: "goodies",
  gender: "unisex",
  tier: "standard",
  description: "Une planche A5 complète de stickers kiss-cut — plusieurs déclinaisons de votre logo sur une seule feuille. Parfait pour les assos, événements et kits de bienvenue. Production et expédition UE.",
  composition: "Vinyle blanc, planche 14,8 × 21 cm",
  weight: "—",
  images: [],
  colors: [
    { id: "blanc", label: "Fond blanc", hex: "#FFFFFF", available: true },
  ],
  sizes: [{ label: "14,8 × 21 cm", available: true }],
  techniques: ["dtf"],
  techniqueRecommandee: "dtf",
  placements: ["coeur"],
  pricing: {
    dtf: PLANCHE_STICKERS_PRICES.dtf,
    dtflex: 0, flex: 0, broderie: 0,
    placements: SINGLE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: SINGLE_PLACEMENT_SURCHARGES,
  },
...
export const PRODUCT_MUG_NOIR_BRILLANT: Product = {
  id: "mug-noir-brillant",
  slug: "mug-noir-brillant",
  reference: "Mug céramique noir",
  name: "Mug noir brillant personnalisé",
  shortName: "Mug noir",
  category: "goodies",
  gender: "unisex",
  tier: "standard",
  description: "Le mug céramique noir brillant qui sublime les logos clairs et blancs — très fréquent en identité d'entreprise. Impression tour complet. Lave-vaisselle et micro-ondes. Production et expédition UE.",
  composition: "Céramique noire brillante",
  weight: "—",
  images: [],
  colors: [
    { id: "noir", label: "Noir", hex: "#1a1a1a", available: true },
  ...
  sizes: [
    { label: "11 oz / 325 ml", available: true },
    { label: "15 oz / 445 ml", available: true },
  ],
  techniques: ["dtf"],
  techniqueRecommandee: "dtf",
  placements: ["coeur"],
  pricing: {
    dtf: MUG_NOIR_PRICES.dtf,
    dtflex: 0, flex: 0, broderie: 0,
    placements: SINGLE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: SINGLE_PLACEMENT_SURCHARGES,
  },
...
export const PRODUCT_DESSOUS_VERRE_LIEGE: Product = {
  id: "dessous-verre-liege",
  slug: "dessous-de-verre-liege",
  reference: "Coaster liège",
  name: "Dessous de verre dos liège personnalisé",
  shortName: "Dessous de verre",
  category: "goodies",
  gender: "unisex",
  tier: "standard",
  description: "Dessous de verre rigide avec dos liège antidérapant, votre logo imprimé pleine surface. Pour les bureaux, salles de réunion, brasseries et restaurants. Production et expédition UE.",
  composition: "Panneau rigide, dos liège",
  weight: "—",
  images: [],
  colors: [
    { id: "blanc", label: "Blanc", hex: "#FFFFFF", available: true },
  ],
  sizes: [{ label: "9,5 × 9,5 cm", available: true }],
  techniques: ["dtf"],
  techniqueRecommandee: "dtf",
  placements: ["coeur"],
  pricing: {
    dtf: DESSOUS_VERRE_PRICES.dtf,
    dtflex: 0, flex: 0, broderie: 0,
    placements: SINGLE_PLACEMENT_SURCHARGES,
    broDeriePlacementSurcharge: SINGLE_PLACEMENT_SURCHARGES,
  },
...
const _ALL_PRODUCTS: Product[] = [
  ...
  // ── Élargissement catalogue #85 — Printful POD vérifié EU (2026-06-12) ───
  PRODUCT_POLO_SOLS_PRESCOTT,          // polo premium SOL'S, S-5XL
  PRODUCT_POLO_GILDAN_64800L,          // polo femme
  PRODUCT_COUPE_VENT_SOLS_32000,       // coupe-vent brodé (seule veste POD EU)
  PRODUCT_CASQUETTE_DAD_HAT_6245,      // dad hat décontractée, 10 coloris
  PRODUCT_CASQUETTE_SNAPBACK_6089,     // snapback, 18 coloris
  PRODUCT_BOB_FLEXFIT_5003,            // bob tendance (premium)
  PRODUCT_BONNET_YUPOONG_1501KC,       // bonnet hiver, 12 coloris
  PRODUCT_TOTE_BAGBASE_W101,           // tote d'appel, 12 coloris, brodable
  PRODUCT_TOTE_DENIM_MANTIS_M196,      // tote denim premium
  PRODUCT_SACOCHE_BAGBASE_QS309,       // sacoche bandoulière
  PRODUCT_STICKERS_LOGO,               // stickers kiss-cut (3 formats)
  PRODUCT_PLANCHE_STICKERS,            // planche A5
  PRODUCT_MUG_NOIR_BRILLANT,           // mug noir (logos clairs)
  PRODUCT_DESSOUS_VERRE_LIEGE,         // dessous de verre liège
];
