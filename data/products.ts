...
export const PRODUCT_BELLA_3001: Product = {
  ...
  images: [],
  colors: [
    // ── Essentiels (mockups disponibles) ───────────────────────────────────
    { id: "noir",            label: "Noir",              hex: "#1a1a1a", available: true },
    { id: "blanc",           label: "Blanc",             hex: "#FAFAF8", available: true },
    { id: "marine",          label: "Marine",            hex: "#1b2a4a", available: true },
    // ── Heather foncés ──────────────────────────────────────────────────────
    { id: "dark-heather",    label: "Dark Grey",         hex: "#3c3d3f", available: true },
    { id: "heather-navy",    label: "Heather Navy",      hex: "#4a5568", available: true },
    { id: "asphalt",         label: "Asphalt",           hex: "#3d3d3d", available: true },
    // ── Gris / Argent ───────────────────────────────────────────────────────
    { id: "athletic-heather",label: "Athletic Heather",  hex: "#b0b0b0", available: true },
    { id: "silver",          label: "Argent",            hex: "#c0c0c0", available: true },
    // ── Bleus ───────────────────────────────────────────────────────────────
    { id: "true-royal",      label: "Bleu Royal",        hex: "#2563EB", available: true },
    { id: "steel-blue",      label: "Acier",             hex: "#4682B4", available: true },
    { id: "teal",            label: "Teal",              hex: "#008080", available: true },
    { id: "aqua",            label: "Aqua",              hex: "#00BCD4", available: true },
    { id: "baby-blue",       label: "Bleu Bébé",         hex: "#87CEEB", available: true },
    { id: "columbia-blue",   label: "Columbia Blue",     hex: "#9EC8E8", available: true },
    // ── Verts ───────────────────────────────────────────────────────────────
    { id: "vert-militaire",  label: "Vert Militaire",    hex: "#4A5240", available: true },
    { id: "olive",           label: "Olive",             hex: "#708238", available: true },
    { id: "kelly",           label: "Kelly Green",       hex: "#4CBB17", available: true },
    { id: "forest",          label: "Vert Forêt",        hex: "#1B4D2E", available: true },
    { id: "mint",            label: "Menthe",            hex: "#98FF98", available: true },
    { id: "leaf",            label: "Vert Feuille",      hex: "#5D8A5E", available: true },
    // ── Rouges / Roses / Violets ────────────────────────────────────────────
    { id: "rouge",           label: "Rouge",             hex: "#CC1414", available: true },
    { id: "cardinal",        label: "Cardinal",          hex: "#8B0000", available: true },
    { id: "bordeaux",        label: "Bordeaux",          hex: "#651d32", available: true },
    { id: "berry",           label: "Berry",             hex: "#883266", available: true },
    { id: "charity-pink",    label: "Rose Charity",      hex: "#F9A8D4", available: true },
    { id: "mauve",           label: "Mauve",             hex: "#C9A0B8", available: true },
    { id: "lilac",           label: "Lilas",             hex: "#C8A2C8", available: true },
    { id: "violet",          label: "Violet",            hex: "#5B21B6", available: true },
    // ── Oranges / Jaunes ────────────────────────────────────────────────────
    { id: "orange",          label: "Orange",            hex: "#F97316", available: true },
    { id: "burnt-orange",    label: "Orange Brûlé",      hex: "#BF5700", available: true },
    { id: "mustard",         label: "Moutarde",          hex: "#D4A017", available: true },
    { id: "gold",            label: "Or",                hex: "#FFD700", available: true },
    { id: "yellow",          label: "Jaune",             hex: "#FDE047", available: true },
    // ── Neutres / Naturels ───────────────────────────────────────────────────
    { id: "natural",         label: "Natural",           hex: "#F5F0E8", available: true },
    { id: "soft-cream",      label: "Crème Douce",       hex: "#FFF8DC", available: true },
    { id: "sand",            label: "Sable",             hex: "#C2B280", available: true },
    { id: "brown",           label: "Marron",            hex: "#795548", available: true },
    { id: "heather-dust",    label: "Heather Dust",      hex: "#A89880", available: true },
  ],
  sizes: [
    { label: "XS",   available: true },
    { label: "S",    available: true },
  ...
  // Mockups locaux HM Global — photos Printful flat, par couleur (front + back + detail)
  // 36 coloris couverts. silver/heather-dust → packshot TopTex (pas de front trouvé).
  hmMockupImages: {
    "noir":             "/mockups/bella-3001/noir-front.png",
    "blanc":            "/mockups/bella-3001/blanc-front.png",
    "marine":           "/mockups/bella-3001/marine-front.png",
    "dark-heather":     "/mockups/bella-3001/dark-heather-front.png",
    "heather-navy":     "/mockups/bella-3001/heather-navy-front.png",
    "asphalt":          "/mockups/bella-3001/asphalt-front.png",
    "athletic-heather": "/mockups/bella-3001/athletic-heather-front.png",
    "true-royal":       "/mockups/bella-3001/true-royal-front.png",
    "steel-blue":       "/mockups/bella-3001/steel-blue-front.png",
    "teal":             "/mockups/bella-3001/teal-front.png",
    "aqua":             "/mockups/bella-3001/aqua-front.png",
    "baby-blue":        "/mockups/bella-3001/baby-blue-front.png",
    "columbia-blue":    "/mockups/bella-3001/columbia-blue-front.png",
    "vert-militaire":   "/mockups/bella-3001/vert-militaire-front.png",
    "olive":            "/mockups/bella-3001/olive-front.png",
    "kelly":            "/mockups/bella-3001/kelly-front.png",
    "leaf":             "/mockups/bella-3001/leaf-front.png",
    "forest":           "/mockups/bella-3001/forest-front.png",
    "mint":             "/mockups/bella-3001/mint-front.png",
    "rouge":            "/mockups/bella-3001/rouge-front.png",
    "cardinal":         "/mockups/bella-3001/cardinal-front.png",
    "bordeaux":         "/mockups/bella-3001/bordeaux-front.png",
    "berry":            "/mockups/bella-3001/berry-front.png",
    "charity-pink":     "/mockups/bella-3001/charity-pink-front.png",
    "mauve":            "/mockups/bella-3001/mauve-front.png",
    "lilac":            "/mockups/bella-3001/lilac-front.png",
    "violet":           "/mockups/bella-3001/violet-front.png",
    "orange":           "/mockups/bella-3001/orange-front.png",
    "burnt-orange":     "/mockups/bella-3001/burnt-orange-front.png",
    "mustard":          "/mockups/bella-3001/mustard-front.png",
    "gold":             "/mockups/bella-3001/gold-front.png",
    "yellow":           "/mockups/bella-3001/yellow-front.png",
    "natural":          "/mockups/bella-3001/natural-front.png",
    "soft-cream":       "/mockups/bella-3001/soft-cream-front.png",
    "sand":             "/mockups/bella-3001/sand-front.png",
    "brown":            "/mockups/bella-3001/brown-front.png",
  },
  hmMockupImagesBack: {
    "noir":             "/mockups/bella-3001/noir-back.png",
    "blanc":            "/mockups/bella-3001/blanc-back.png",
    "marine":           "/mockups/bella-3001/marine-back.png",
    "dark-heather":     "/mockups/bella-3001/dark-heather-back.png",
    "heather-navy":     "/mockups/bella-3001/heather-navy-back.png",
    "asphalt":          "/mockups/bella-3001/asphalt-back.png",
    "athletic-heather": "/mockups/bella-3001/athletic-heather-back.png",
    "true-royal":       "/mockups/bella-3001/true-royal-back.png",
    "steel-blue":       "/mockups/bella-3001/steel-blue-back.png",
    "teal":             "/mockups/bella-3001/teal-back.png",
    "aqua":             "/mockups/bella-3001/aqua-back.png",
    "baby-blue":        "/mockups/bella-3001/baby-blue-back.png",
    "columbia-blue":    "/mockups/bella-3001/columbia-blue-back.png",
    "vert-militaire":   "/mockups/bella-3001/vert-militaire-back.png",
    "olive":            "/mockups/bella-3001/olive-back.png",
    "kelly":            "/mockups/bella-3001/kelly-back.png",
    "leaf":             "/mockups/bella-3001/leaf-back.png",
    "forest":           "/mockups/bella-3001/forest-back.png",
    "mint":             "/mockups/bella-3001/mint-back.png",
    "rouge":            "/mockups/bella-3001/rouge-back.png",
    "cardinal":         "/mockups/bella-3001/cardinal-back.png",
    "bordeaux":         "/mockups/bella-3001/bordeaux-back.png",
    "berry":            "/mockups/bella-3001/berry-back.png",
    "charity-pink":     "/mockups/bella-3001/charity-pink-back.png",
    "lilac":            "/mockups/bella-3001/lilac-back.png",
    "violet":           "/mockups/bella-3001/violet-back.png",
    "orange":           "/mockups/bella-3001/orange-back.png",
    "burnt-orange":     "/mockups/bella-3001/burnt-orange-back.png",
    "mustard":          "/mockups/bella-3001/mustard-back.png",
    "gold":             "/mockups/bella-3001/gold-back.png",
    "yellow":           "/mockups/bella-3001/yellow-back.png",
    "natural":          "/mockups/bella-3001/natural-back.png",
    "soft-cream":       "/mockups/bella-3001/soft-cream-back.png",
    "sand":             "/mockups/bella-3001/sand-back.png",
    "brown":            "/mockups/bella-3001/brown-back.png",
  },
  hmMockupGallery: {
    ...
    "dark-heather":     ["/mockups/bella-3001/dark-heather-front.png",     "/mockups/bella-3001/dark-heather-back.png",     "/mockups/bella-3001/dark-heather-detail.png"],
    "heather-navy":     ["/mockups/bella-3001/heather-navy-front.png",     "/mockups/bella-3001/heather-navy-back.png",     "/mockups/bella-3001/heather-navy-detail.png"],
    "asphalt":          ["/mockups/bella-3001/asphalt-front.png",          "/mockups/bella-3001/asphalt-back.png",          "/mockups/bella-3001/asphalt-detail.png"],
    ...
    "steel-blue":       ["/mockups/bella-3001/steel-blue-front.png",       "/mockups/bella-3001/steel-blue-back.png",       "/mockups/bella-3001/steel-blue-detail.png"],
    "teal":             ["/mockups/bella-3001/teal-front.png",             "/mockups/bella-3001/teal-back.png",             "/mockups/bella-3001/teal-detail.png"],
    "aqua":             ["/mockups/bella-3001/aqua-front.png",             "/mockups/bella-3001/aqua-back.png",             "/mockups/bella-3001/aqua-detail.png"],
    "baby-blue":        ["/mockups/bella-3001/baby-blue-front.png",        "/mockups/bella-3001/baby-blue-back.png",        "/mockups/bella-3001/baby-blue-detail.png"],
    "columbia-blue":    ["/mockups/bella-3001/columbia-blue-front.png",    "/mockups/bella-3001/columbia-blue-back.png",    "/mockups/bella-3001/columbia-blue-detail.png"],
    "vert-militaire":   ["/mockups/bella-3001/vert-militaire-front.png",   "/mockups/bella-3001/vert-militaire-back.png",   "/mockups/bella-3001/vert-militaire-detail.png"],
    "olive":            ["/mockups/bella-3001/olive-front.png",            "/mockups/bella-3001/olive-back.png",            "/mockups/bella-3001/olive-detail.png"],
    "kelly":            ["/mockups/bella-3001/kelly-front.png",            "/mockups/bella-3001/kelly-back.png",            "/mockups/bella-3001/kelly-detail.png"],
    "leaf":             ["/mockups/bella-3001/leaf-front.png",             "/mockups/bella-3001/leaf-back.png",             "/mockups/bella-3001/leaf-detail.png"],
    "forest":           ["/mockups/bella-3001/forest-front.png",           "/mockups/bella-3001/forest-back.png",           "/mockups/bella-3001/forest-detail.png"],
    "mint":             ["/mockups/bella-3001/mint-front.png",             "/mockups/bella-3001/mint-back.png",             "/mockups/bella-3001/mint-detail.png"],
    "rouge":            ["/mockups/bella-3001/rouge-front.png",            "/mockups/bella-3001/rouge-back.png",            "/mockups/bella-3001/rouge-detail.png"],
    "cardinal":         ["/mockups/bella-3001/cardinal-front.png",         "/mockups/bella-3001/cardinal-back.png",         "/mockups/bella-3001/cardinal-detail.png"],
    "bordeaux":         ["/mockups/bella-3001/bordeaux-front.png",         "/mockups/bella-3001/bordeaux-back.png",         "/mockups/bella-3001/bordeaux-detail.png"],
    "berry":            ["/mockups/bella-3001/berry-front.png",            "/mockups/bella-3001/berry-back.png",            "/mockups/bella-3001/berry-detail.png"],
    "charity-pink":     ["/mockups/bella-3001/charity-pink-front.png",     "/mockups/bella-3001/charity-pink-back.png",     "/mockups/bella-3001/charity-pink-detail.png"],
    "mauve":            ["/mockups/bella-3001/mauve-front.png"],
    "lilac":            ["/mockups/bella-3001/lilac-front.png",            "/mockups/bella-3001/lilac-back.png",            "/mockups/bella-3001/lilac-detail.png"],
    "violet":           ["/mockups/bella-3001/violet-front.png",           "/mockups/bella-3001/violet-back.png",           "/mockups/bella-3001/violet-detail.png"],
    "orange":           ["/mockups/bella-3001/orange-front.png",           "/mockups/bella-3001/orange-back.png",           "/mockups/bella-3001/orange-detail.png"],
    "burnt-orange":     ["/mockups/bella-3001/burnt-orange-front.png",     "/mockups/bella-3001/burnt-orange-back.png",     "/mockups/bella-3001/burnt-orange-detail.png"],
    "mustard":          ["/mockups/bella-3001/mustard-front.png",          "/mockups/bella-3001/mustard-back.png",          "/mockups/bella-3001/mustard-detail.png"],
    "gold":             ["/mockups/bella-3001/gold-front.png",             "/mockups/bella-3001/gold-back.png",             "/mockups/bella-3001/gold-detail.png"],
    "yellow":           ["/mockups/bella-3001/yellow-front.png",           "/mockups/bella-3001/yellow-back.png",           "/mockups/bella-3001/yellow-detail.png"],
    "natural":          ["/mockups/bella-3001/natural-front.png",          "/mockups/bella-3001/natural-back.png",          "/mockups/bella-3001/natural-detail.png"],
    "soft-cream":       ["/mockups/bella-3001/soft-cream-front.png",       "/mockups/bella-3001/soft-cream-back.png",       "/mockups/bella-3001/soft-cream-detail.png"],
    "sand":             ["/mockups/bella-3001/sand-front.png",             "/mockups/bella-3001/sand-back.png",             "/mockups/bella-3001/sand-detail.png"],
    "brown":            ["/mockups/bella-3001/brown-front.png",            "/mockups/bella-3001/brown-back.png"],
  },
};
...
export const PRODUCT_GILDAN_18000: Product = {
  ...
  colors: [
    ...
    { id: "blanc",          label: "Blanc",            hex: "#ffffff", available: true },
    { id: "dark-heather",   label: "Dark Heather",     hex: "#46484d", available: true },
    ...
    { id: "vert-foret",     label: "Vert Forêt",       hex: "#1A3626", available: true },
    { id: "vert-irlandais", label: "Vert Irlandais",   hex: "#00B365", available: true },
    { id: "chocolat",       label: "Chocolat Foncé",   hex: "#35241b", available: true },
    { id: "sable",          label: "Sable",            hex: "#e7d3b3", available: true },
    { id: "cendré",         label: "Cendré",           hex: "#ededed", available: true },
    { id: "bleu-profond",   label: "Bleu Profond",     hex: "#6898f2", available: true },
  ],
  sizes: [
    { label: "S",    available: true },
    { label: "M",    available: true },
  ...
  hmMockupImages: {
    ...
    "bordeaux":   "/mockups/gildan-18000/bordeaux-front.jpg",
    "bleu-clair": "/mockups/gildan-18000/bleu-clair-front.jpg",
  },
  hmMockupImagesBack: {
    ...
    "bordeaux":   "/mockups/gildan-18000/bordeaux-back.jpg",
    "bleu-clair": "/mockups/gildan-18000/bleu-clair-back.jpg",
  },
  hmMockupGallery: {
    ...
    "bordeaux":   ["/mockups/gildan-18000/bordeaux-front.jpg",   "/mockups/gildan-18000/bordeaux-back.jpg",   "/mockups/gildan-18000/bordeaux-detail.jpg"],
    "bleu-clair": ["/mockups/gildan-18000/bleu-clair-front.jpg", "/mockups/gildan-18000/bleu-clair-back.jpg", "/mockups/gildan-18000/bleu-clair-detail.jpg"],
  },
};
